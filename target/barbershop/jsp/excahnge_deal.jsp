...
<div class="page-container">
    <div class="title title-on">到店兑换</div>
    <div class="title "><a href="point_gifts/point_giftList">兑换记录</a></div>
    ...
    <table>
        <thead>
        <tr>
            <th scope="col" colspan="5">礼品兑换信息</th>
        </tr>
        <th width="70">ID</th>
        <th width="70">会员</th>
        <th width="70">礼品</th>
            ...
            <c:forEach var="point_gift" varStatus="status" items="${point_gifts}">
                <div class="row">
                    <tr class="text-c">
                        ...
                        <td>
                            <a onclick="dealToFact(${point_gift.pointGiftId})" href="javascript:;">到店领取</a>
                        </td>
                    </tr>
                </div>
